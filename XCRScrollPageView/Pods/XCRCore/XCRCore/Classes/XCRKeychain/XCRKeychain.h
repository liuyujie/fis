...
/**
 Error code specific to XCRKeychain that can be returned in NSError objects.
 For codes returned by the operating system, refer to SecBase.h for your
 platform.
 */
typedef NS_ENUM(OSStatus, XCRKeychainErrorCode) {
	/** Some of the arguments were invalid. */
	XCRKeychainErrorBadArguments = -1001,
};

/** XCRKeychain error domain */
extern NSString *const kXCRKeychainErrorDomain;

/** Account name. */
extern NSString *const kXCRKeychainAccountKey;
 ...
 */
extern NSString *const kXCRKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kXCRKeychainClassKey;

/** Item description. */
extern NSString *const kXCRKeychainDescriptionKey;

/** Item label. */
extern NSString *const kXCRKeychainLabelKey;

/** Time the item was last modified.

 The value will be a string.
 */
extern NSString *const kXCRKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kXCRKeychainWhereKey;
...
/**
 ...
 XCRKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface XCRKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in XCRKeychain.h for a list of keys that can be used when accessing the
