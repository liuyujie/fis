...
NS_ASSUME_NONNULL_BEGIN
	...
	#define XCRKeychain_SYNCHRONIZATION_AVAILABLE 1
#endif

#if __IPHONE_3_0 || __MAC_10_9
	// Keychain access group available at compile time
	#define XCRKeychain_ACCESS_GROUP_AVAILABLE 1
#endif

#ifdef XCRKeychain_SYNCHRONIZATION_AVAILABLE
typedef NS_ENUM(NSUInteger, XCRKeychainQuerySynchronizationMode) {
	XCRKeychainQuerySynchronizationModeAny,
	XCRKeychainQuerySynchronizationModeNo,
	XCRKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface XCRKeychainQuery : NSObject
...
@property (nonatomic) XCRKeychainQuerySynchronizationMode synchronizationMode;
#endif
...
/**
 ...
 XCRKeychain_SYNCHRONIZATION_AVAILABLE is only for compile time. If you are checking for the presence of synchronization,
